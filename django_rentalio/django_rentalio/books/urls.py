...
from .views import BookTitleListView, BookTitleDetailView, BookDetailView, BookDeleteView
...
urlpatterns = [
    ...
    path('books/<str:letter>/<slug:slug>/<str:book_id>/delete/', BookDeleteView.as_view(), name='delete-book'),
